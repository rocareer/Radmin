...
class Menu
{
     ...
     * @throws Throwable
     */
    public static function create(array $menu, int|string $parent = 0, string $mode = 'cover', string $position = 'backend')
    {
        $pid        = 0;
     ...
     * @throws Throwable
     */
    public static function delete(null|string|int $id, bool $recursion = false, string $position = 'backend'): bool
    {
        if (!$id) {
            return true;
        }
