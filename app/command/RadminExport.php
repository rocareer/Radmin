...
class RadminExport extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->plugin_vendor= RadminExport . phpbase_path() . DIRECTORY_SEPARATOR .'vendor/rocareer/webman-radmin';
    ...
    public function sync()
    {
        foreach ($this->paths as $source=>$target) {
            $source= RadminExport . phpbase_path() . DIRECTORY_SEPARATOR .$source;
