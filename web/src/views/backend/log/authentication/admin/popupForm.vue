    ...
    >
        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    <FormItem
                        :label="t('log.authentication.admin.admin_id')"
                        type="remoteSelect"
                    ...
                    <FormItem
                        ...
                        prop="action"
                        :input-attr="{ content: { '1': t('log.authentication.admin.action 1'), '2': t('log.authentication.admin.action 2') } }"
                    />
                </el-form>
            </div>
        </el-scrollbar>
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    create_time: [buildValidatorData({ name: 'date', title: t('log.authentication.admin.create_time') })],
})
</script>
