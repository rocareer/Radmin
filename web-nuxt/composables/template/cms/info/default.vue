                    ...
                    <div class="content-box">
                        ...
                        <div class="footer">
                                    ...
                                    <div class="share-item border-green">
                                        <el-tooltip effect="light" placement="top">
                                            <template #content>
                                                ...
                                                <qrcode-vue :value="getCurrentUrl()" :size="160" :margin="4" level="H" />
                                            </template>
                            ...
                            <div class="content-info">
                                <div v-if="!isEmpty(state.content.cmsTags.name)" class="info-item">
                                    <span>本文标签：</span>
                                    <NuxtLink
                                ...
                                <div v-if="state.content.cmsChannel" class="info-item">本文分类：{{ state.content.cmsChannel.name }}</div>
                                <div class="info-item">发布日期：{{ timeFormat(state.content.create_time, 'yyyy-mm-dd') }}</div>
                                <client-only>
                                    <div class="info-item">本文链接：{{ getCurrentUrl() }}</div>
                                </client-only>
                            </div>
                            ...
                            <!-- 同频道文章 -->
                            <el-row v-if="data.hotContent" class="related-article" :gutter="15">
                                <el-col v-for="(hot, hotIdx) in data.hotContent" :key="hotIdx" :span="6">
                                    <div class="related-article-item">
                                        <NuxtLink :to="{ name: 'cmsInfo', params: { id: hot.id } }">
                                            <el-image loading="lazy" class="img suspension" fit="cover" :src="getFirstImage(hot.images)">
                                                <template #placeholder>
                                                    <div class="img-loading-placeholder">
                                                        <Loading />
                                                    </div>
