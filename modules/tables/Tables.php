...
class Tables
{
    ...
    public function install(): void
    {
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'path'      => 'examples/table/treetable',
                        'icon'      => 'fa fa-table',
                        'menu_type' => 'tab',
                        'component' => '/src/views/backend/examples/table/treetable/index.vue',
                        'keepalive' => '1',
                        'children'  => [
                            ['type' => 'button', 'title' => '查看', 'name' => 'examples/table/treetable/index'],
                            ['type' => 'button', 'title' => '添加', 'name' => 'examples/table/treetable/add'],
                            ['type' => 'button', 'title' => '编辑', 'name' => 'examples/table/treetable/edit'],
                            ['type' => 'button', 'title' => '删除', 'name' => 'examples/table/treetable/del'],
                        ],
                    ],
                    [
                        'type'      => 'menu',
        ...
        // v1.0.4 新增
        $formMenu  = AdminRule::where('name', 'examples/table/form')->value('id');
        $tableMenu = AdminRule::where('name', 'examples/table')->value('id');
        $menu      = [
            [
                'type'      => 'menu',
                'title'     => '远程下拉联动',
                'name'      => 'examples/table/form/linkage',
                'path'      => 'examples/table/form/linkage',
                'menu_type' => 'tab',
                'component' => '/src/views/backend/examples/table/form/linkage/index.vue',
                'keepalive' => '1',
                'weigh'     => '8',
                'pid'       => $formMenu,
                'children'  => [
                    ['type' => 'button', 'title' => '查看', 'name' => 'examples/table/form/linkage/index'],
                    ['type' => 'button', 'title' => '添加', 'name' => 'examples/table/form/linkage/add'],
                    ['type' => 'button', 'title' => '编辑', 'name' => 'examples/table/form/linkage/edit'],
                    ['type' => 'button', 'title' => '删除', 'name' => 'examples/table/form/linkage/del'],
                ],
            ],
            [
                'type'     => 'menu_dir',
                'title'    => '公共搜索',
                'name'     => 'examples/table/search',
                'path'     => 'examples/table/search',
                'pid'      => $tableMenu,
                'children' => [
                    [
                        'type'      => 'menu',
                        'title'     => '自定义渲染',
                        'name'      => 'examples/table/search/slot',
                        'path'      => 'examples/table/search/slot',
                        'menu_type' => 'tab',
                        'component' => '/src/views/backend/examples/table/search/slot/index.vue',
                        'keepalive' => '1',
                        'weigh'     => '9',
                        'children'  => [
                            ['type' => 'button', 'title' => '查看', 'name' => 'examples/table/search/slot/index'],
                            ['type' => 'button', 'title' => '添加', 'name' => 'examples/table/search/slot/add'],
                            ['type' => 'button', 'title' => '编辑', 'name' => 'examples/table/search/slot/edit'],
                            ['type' => 'button', 'title' => '删除', 'name' => 'examples/table/search/slot/del'],
                        ],
                    ],
                    [
                        'type'      => 'menu',
                        ...
                        'path'      => 'examples/table/search/linkage',
                        'menu_type' => 'tab',
                        'component' => '/src/views/backend/examples/table/search/linkage/index.vue',
                        'keepalive' => '1',
                        'weigh'     => '8',
                        'children'  => [
                            ['type' => 'button', 'title' => '查看', 'name' => 'examples/table/search/linkage/index'],
                            ['type' => 'button', 'title' => '添加', 'name' => 'examples/table/search/linkage/add'],
                            ['type' => 'button', 'title' => '编辑', 'name' => 'examples/table/search/linkage/edit'],
                            ['type' => 'button', 'title' => '删除', 'name' => 'examples/table/search/linkage/del'],
                        ],
                    ],
                ],
            ]
