...
(
    `id`          int UNSIGNED    NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `number1`     int             NULL DEFAULT NULL COMMENT '数字1',
    `number2`     int             NULL DEFAULT NULL COMMENT '数字2',
    `float1`      decimal(5, 2)   NULL DEFAULT NULL COMMENT '浮点数1',
    `float2`      decimal(5, 2)   NULL DEFAULT NULL COMMENT '浮点数2',
    `create_time` bigint UNSIGNED NULL DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    `id`          int UNSIGNED                                                  NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `string`      varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '字符串',
    `number`      int                                                           NULL     DEFAULT NULL COMMENT '数字',
    `float`       decimal(5, 2)                                                 NULL     DEFAULT NULL COMMENT '浮点数',
    `date`        date                                                          NULL     DEFAULT NULL COMMENT '日期',
...
(
    `id`          int UNSIGNED                                                  NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `date`        date                                                          NULL     DEFAULT NULL COMMENT '日期',
    `user_id`     int UNSIGNED                                                  NULL     DEFAULT NULL COMMENT '远程下拉',
...
(
    ...
    `user_id`     int UNSIGNED                                                  NULL     DEFAULT NULL COMMENT '会员ID',
    `create_time` bigint UNSIGNED                                               NULL     DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
VALUES (1, '我是字符串', 'https://uni.buildadmin.com', '/static/images/avatar.png', 'el-icon-ColdDrink', '#C60000', 1,
        1, 1691563283);

-- ----------------------------
-- v1.0.1
-- ----------------------------
CREATE TABLE IF NOT EXISTS `__PREFIX__examples_table_treetable`
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='树状表格示例表';

BEGIN;
INSERT INTO `__PREFIX__examples_table_treetable`
VALUES ('1', '0', '顶级1', '1666980437'),
       ('2', '0', '顶级2', '1666980443'),
       ('3', '1', '顶级1的第1个子级', '1666980514'),
       ('4', '1', '顶级1的第2个子级', '1666980526'),
       ('5', '2', '顶级2的第1个子级', '1666980526');

-- ----------------------------
-- v1.0.4
-- ----------------------------
CREATE TABLE IF NOT EXISTS `__PREFIX__examples_table_search_linkage`
(
    `id`          int UNSIGNED                                                           NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `type`        enum ('user','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'user' COMMENT '类型:user=会员,admin=管理员',
    `user_id`     int UNSIGNED                                                           NULL DEFAULT NULL COMMENT '会员',
    `admin_id`    int UNSIGNED                                                           NULL DEFAULT NULL COMMENT '管理员',
    `group_id`    int UNSIGNED                                                           NULL DEFAULT NULL COMMENT '分组',
    `create_time` bigint UNSIGNED                                                        NULL DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '远程下拉联动'
  ROW_FORMAT = DYNAMIC;

INSERT INTO `__PREFIX__examples_table_search_linkage`
VALUES (1, 'user', 1, NULL, 1, 1747039340),
       (2, 'admin', NULL, 1, 1, 1747039347);

CREATE TABLE IF NOT EXISTS `__PREFIX__examples_table_search_slot`
(
    `id`          int UNSIGNED                                                          NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `string`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci         NOT NULL DEFAULT '' COMMENT '字符串',
    `radio`       enum ('opt0','opt1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL     DEFAULT 'opt0' COMMENT '单选框:opt0=选项一,opt1=选项二',
    `checkbox`    set ('opt0','opt1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NULL     DEFAULT 'opt0,opt1' COMMENT '复选框:opt0=选项一,opt1=选项二',
    `user_id`     int UNSIGNED                                                          NULL     DEFAULT NULL COMMENT '会员',
    `create_time` bigint UNSIGNED                                                       NULL     DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '公共搜索自定义渲染'
  ROW_FORMAT = DYNAMIC;

INSERT INTO `__PREFIX__examples_table_search_slot`
VALUES (1, '字符串1', 'opt0', 'opt0,opt1', 1, 1747036905),
       (2, '字符串2', 'opt1', 'opt0,opt1', 2, 1747037844);

CREATE TABLE IF NOT EXISTS `__PREFIX__examples_table_form_linkage`
(
    `id`          int UNSIGNED                                                           NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `radio`       enum ('user','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'user' COMMENT '类型:user=会员,admin=管理员',
    `user_id`     int UNSIGNED                                                           NULL DEFAULT NULL COMMENT '会员',
    `admin_id`    int UNSIGNED                                                           NULL DEFAULT NULL COMMENT '管理员',
    `group_id`    int UNSIGNED                                                           NULL DEFAULT NULL COMMENT '分组',
    `create_time` bigint UNSIGNED                                                        NULL DEFAULT NULL COMMENT '创建时间',
...
INSERT INTO `__PREFIX__examples_table_form_linkage`
VALUES (1, 'user', 1, NULL, 1, 1747034917),
       (2, 'admin', NULL, 1, 2, 1747034923);
